...
- `context/`: Parity context pack
- `.github/workflows/parity.yml`: GitHub Actions workflow for the copied demo repo
...
Follow [docs/quickstart.md](docs/quickstart.md). It covers environment setup, seeding the LangSmith dataset, applying the demo patch, and inspecting Parity's output end-to-end.
