...
from parity.models.eval_case import ConversationMessage, is_conversation_input
...
class ExportFormats(ParityModel):
    promptfoo: str | None = None
    deepeval: str | None = None
    raw_json: str | None = None


class ProbeProposal(ParityModel):
